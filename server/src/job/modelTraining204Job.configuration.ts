...
export class ModelTraining204JobConfiguration extends JobConfiguration {
    ...
    private static kerasModelString = tf.sequential({
        layers: [
            tf.layers.embedding({
                inputDim: 90,
                outputDim: 32,
    ...
    lambdaResourceService: LambdaResourceService,
        ...
        this.job = new ModelTrainingJob(ModelTraining204JobConfiguration.jobDefinition, lambdaResourceService, ModelTraining204JobConfiguration.trainingInput)
    }

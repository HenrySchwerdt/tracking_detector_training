...
export class JobRun {
  ...
  @ApiProperty({
    example: 'ad12321asd1213',
    description: 'The unique job id for that run.',
  })
  jobId: string;
  ...
  @ApiProperty({
    example: 1231231231,
    description: 'The starting time in miliseconds.',
  })
  startTime: number;
  ...
  @ApiProperty({
    example: 1231231231,
    description: 'The ending time in miliseconds.',
  })
  endTime: number;
